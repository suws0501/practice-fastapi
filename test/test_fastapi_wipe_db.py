...
SYNC_DB_URL = "postgresql+psycopg2://postgres:69696969@localhost:5432/testdb"
sync_engine = sa.create_engine(SYNC_DB_URL)


@pytest.fixture(scope="module", autouse=True)
def clear_todos_table():
    with sync_engine.connect() as conn:
        conn.execute(sa.text("TRUNCATE TABLE todos;"))
        conn.commit()
